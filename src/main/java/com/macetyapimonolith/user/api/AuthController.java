...
import com.macetyapimonolith.common.security.JwtService;
...
public class AuthController {
    ...
    public ResponseEntity<?> login(@Valid @RequestBody LoginRequest request) {
        ...
        AuthResponse resp = new AuthResponse(token, refreshToken, "Bearer", jwtService.getExpirationInSeconds(), userSafe);
